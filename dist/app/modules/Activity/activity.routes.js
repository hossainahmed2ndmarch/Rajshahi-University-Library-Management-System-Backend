...
router.get('/categories', activity_controller_1.ActivityController.getCategories);
router.get('/:idOrSlug', activity_controller_1.ActivityController.getActivityById);
// ── Admin + Super Admin Routes ────────────────────────────────────────────────
router.post('/upload-banner', (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN), uploadImage_1.uploadActivityBanner, activity_controller_1.ActivityController.uploadBanner);
