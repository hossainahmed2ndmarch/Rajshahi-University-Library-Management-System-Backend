...
router.get('/active', shiftLog_controller_1.ShiftLogController.getActiveShift);
// 0b. Public — email action token (start / cancel without login)
router.post('/email-action', (0, validateRequest_1.default)(shiftLog_validation_1.ShiftLogValidation.emailActionValidationSchema), shiftLog_controller_1.ShiftLogController.emailAction);
