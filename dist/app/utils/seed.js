...
function seedSuperAdmin() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!process.env.SUPER_ADMIN_EMAIL || !process.env.SUPER_ADMIN_PASSWORD) {
            console.warn('⚠️  [SECURITY WARNING] SUPER_ADMIN_EMAIL or SUPER_ADMIN_PASSWORD not detected in environment. Using standard default fallbacks.');
        }
        // 1. Hash administrative password securely
        const hashedPassword = yield bcrypt.hash(SUPER_ADMIN_CONFIG.password, SUPER_ADMIN_CONFIG.saltRounds);
...
const SAMPLE_USERS = [
    ...
    },
    {
        ...
        role: client_1.UserRole.SHIFTER,
        status: client_1.UserStatus.ACTIVE,
...
function seedSampleUsers() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const u of SAMPLE_USERS) {
            const hashedPassword = yield bcrypt.hash(u.password, salt);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const book of INITIAL_BOOKS) {
            yield prisma.book.upsert({
                ...
                create: Object.assign(Object.assign({}, book), { addedById: adminId }),
            });
        }
...
function seedGalleryAndAssets() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const asset of initialAssets) {
            yield prisma.galleryItem.upsert({
        ...
        const initialGallery = [
            ...
            },
            {
                ...
                org: client_1.Organization.BOTH,
        ...
        for (const item of initialGallery) {
            const existing = yield prisma.galleryItem.findFirst({
                where: { title: item.title },
            });
            if (!existing) {
                yield prisma.galleryItem.create({
                    data: Object.assign(Object.assign({}, item), { isPublished: true, mediaType: client_1.MediaType.IMAGE }),
                });
            }
        }
